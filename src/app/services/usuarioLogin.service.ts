...
import { usuariosLogin } from '../mocks/listaUsuariosLogin'
...
export class UsuarioLoginService {
  ...
  verificarUsuario(usuarioLogin: UsuarioLogin) {
    ...
    const usuarioEncontrado = usuariosLogin.find((u) => u.usuario.toLowerCase() === usuarioLogin.usuario && u.contrasenia === usuarioLogin.contrasenia)
